...
?>
	...
	foreach ($optionals as $k => $o) {
		...
		//
		?>
			<tr><td class="vrc-tableopt-td-img"><?php echo (!empty($o['img']) ? "<img src=\"".JURI::root()."administrator/components/com_vikrentcar/resources/".$o['img']."\" align=\"middle\" />" : "") ?></td><td class="vrc-tableopt-td-name"><?php echo $o['name']; ?></td><td class="vrc-tableopt-td-price"><span class="vrc_currency"><?php echo $currencysymb; ?></span> <span class="vrc_price"><?php echo ($tax_summary ? $optcost : vikrentcar::numberFormat(vikrentcar::sayOptionalsPlusIva($optcost, $o['idiva']))); ?></span></td><td class="vrc-tableopt-td-ckbx"><?php echo $optquaninp; ?></td></tr>
			<?php
