			...
			<div class="vrc-car-result-rightinner">
				<div class="vrc-car-result-rightinner-deep">
					<div class="vrc-car-result-inner">
						<span class="vrc-car-name"><a href="<?php echo JRoute::_('index.php?option=com_vikrentcar&view=cardetails&carid='.$c['id'].(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>"><?php echo $vcategory; ?><?php echo strlen($vcategory) > 0 ? ':' : ''; ?> <?php echo $c['name']; ?></a></span>
					...
					<div class="vrc-car-lastblock">
						...
						<div class="vrc-car-bookingbtn">
							<span class="vrclistgoon"><a href="<?php echo JRoute::_('index.php?option=com_vikrentcar&view=cardetails&carid='.$c['id'].(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>"><?php echo JText::_('VRCLISTPICK'); ?></a></span>
						</div>
					</div>
				</div>
			</div>
