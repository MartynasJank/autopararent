...
if ($printer != 1) {
?>
<div class="vrcprintdiv"><a href="<?php echo JRoute::_('index.php?option=com_vikrentcar&task=vieworder&sid='.$ord['sid'].'&ts='.$ord['ts'].'&printer=1&tmpl=component'.(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>" target="_blank"><img src="<?php echo JURI::root(); ?>components/com_vikrentcar/resources/images/vikrentcar_print.jpg" title="<?php echo JText::_('VRCPRINTCONFORDER'); ?>"/></a></div>
<?php
}
...
?>
		...
		<div class="vrcvordcosts">
			...
			if(is_array($tar)){
			?>
			<p><span class="vrcvordcoststitle"><?php echo $prname; ?>:</span> <span class="vrc_currency"><?php echo $currencysymb; ?></span> <span class="vrc_price"><?php echo vikrentcar::numberFormat(($is_cust_cost ? $tar['cost'] : vikrentcar::sayCostPlusIva($tar['cost'], $tar['idprice'], $ord))); ?></span></p>
			<?php } ?>
			...
			<p><span class="vrcvordcoststitle"><?php echo JText::_('VRCCOUPON').' '.$expcoupon[2]; ?>:</span> - <span class="vrc_currency vrc_keepcost"><?php echo $currencysymb; ?></span> <span class="vrc_price vrc_keepcost"><?php echo vikrentcar::numberFormat($expcoupon[1]); ?></span></p>
			<?php } ?>
			<p class="vrcvordcoststot"><span class="vrcvordcoststitle"><?php echo JText::_('VRTOTAL'); ?>:</span> <span class="vrc_currency vrc_keepcost"><?php echo $currencysymb; ?></span> <span class="vrc_price vrc_keepcost"><?php echo vikrentcar::numberFormat($ord['order_total']); ?></span></p>
			<?php
			if($ord['totpaid'] > 0.00 && !($ord['totpaid'] > $ord['order_total'])) {
				?>
				<p class="vrcvordcoststot"><span class="vrcvordcoststitle"><?php echo JText::_('VRCAMOUNTPAID'); ?>:</span> <span class="vrc_currency vrc_keepcost"><?php echo $currencysymb; ?></span> <span class="vrc_price vrc_keepcost"><?php echo vikrentcar::numberFormat($ord['totpaid']); ?></span></p>
				<?php
			}
			?>
		</div>
