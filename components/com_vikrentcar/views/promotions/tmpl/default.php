				...
				<?php
					...
					<div class="vrc-promotion-car-block">
						...
						<div class="vrc-promotion-car-book-block">
							<a class="vrc-promotion-car-book-link" href="<?php echo JRoute::_('index.php?option=com_vikrentcar&view=cardetails&carid='.$car['id'].'&pickup='.$promo['promo_from_ts'].'&promo=1'.(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>"><?php echo JText::_('VRCPROMOCARBOOKNOW'); ?></a>
						</div>
					</div>
						<?php
					}
