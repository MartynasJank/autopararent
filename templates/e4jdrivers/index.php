...
<?php 
  ...
  $get_carlayout = $this->params->get('car-layout'); 
...
<link rel="stylesheet" href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/css/fonts/<?php echo $bodyfont; ?>.css" type="text/css" />
...
<body class="e4j-body-page <?php echo $get_carlayout; ?>">
<?php 
  include('./templates/'.$this->template.'/blocks/default.php');
?>
<script>
  jQuery("#vrc-search-results-block").addClass('<?php echo $get_carlayout; ?>');
</script>
</body>
</html>