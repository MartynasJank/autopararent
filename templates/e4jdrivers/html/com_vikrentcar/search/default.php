...
<div class="vrc-searchfilter-characteristics-container">
	...
	foreach ($all_characteristics as $chk => $chv) {
		...
		?>
			<span class="vrc-searchfilter-cname"><?php echo !empty($characteristics_map[$chk]['textimg']) ? JText::_($characteristics_map[$chk]['textimg']) : $characteristics_map[$chk]['name']; ?></span>
				...
				<div class="vrc-car-result-rightinner">
					<div class="vrc-car-result-rightinner-deep">
						<div class="vrc-car-result-inner">
							<span class="vrc-car-name"><?php echo JText::_($vcategory); ?><?php echo strlen($vcategory) > 0 ? ':' : ''; ?> <?php echo $getcar['name']; ?></span>
						...
						<div class="vrc-car-lastblock">
							<div class="vrc-car-lastblock-inner">								
								...
								<div class="vrc-car-bookingbtn">
									<form action="<?php echo JRoute::_('index.php?option=com_vikrentcar'.(!empty($pitemid) ?vrc-search-results-block : '')); ?>" method="get">
...
?>
	<div class="goback">
		<a class="btn" href="<?php echo JRoute::_('index.php?option=com_vikrentcar&view=vikrentcar&pickup='.$pickup.'&return='.$release.(!empty($pitemid) ? : '')); ?>"><?php echo JText::_('VRCHANGEDATES'); ?></a>
	</div>
</div>
<?php
