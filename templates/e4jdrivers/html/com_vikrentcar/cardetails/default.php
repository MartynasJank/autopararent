	...
	<div class="vrc-cdetails-cmainimg">
		...
		<div class="cardetails_moreimages">
			...
			foreach($moreimages as $mimg) {
				if(!empty($mimg)) {
				?>
				<a href="<?php echo JURI::root(); ?>administrator/components/com_vikrentcar/resources/big_<?php echo $mimg; ?>" rel="vrcgroup<?php echo $car['id']; ?>" target="_blank" class="vrcmodal"><img src="<?php echo JURI::root(); ?>administrator/components/com_vikrentcar/resources/big_<?php echo $mimg; ?>"/></a>
				<?php
				}
			}
			?>
...
<div class="vrc-cdetails-main">
	<div class="vrc-cdetails-inner">
		...
		<div class="vrc-cdetails-cost">
			...
			<span class="car_cost"><span class="vrc_currency"><?php echo $currencysymb; ?></span> <span class="vrc_price"><?php echo strlen($car['startfrom']) > 0 ? $car['startfrom'] : $car['cost']; ?></span></span>
		</div>
		<?php
		}
...
<div class="vrc-cdetails-calendars">
	<form action="<?php echo JRoute::_('index.php?option=com_vikrentcar&view=cardetails&carid='.$car['id']); ?>" method="post" name="vrcmonths" autocomplete="off">
	<div class="vrc-cdetails-cal-select"><select name="month" onchange="javascript: document.vrcmonths.submit();" class="vrcselectm"><?php echo $moptions; ?></select></div>
	</form>
	...
	<div class="vrclegendediv">
		...
		<span class="vrclegenda"><div class="vrclegfree">&nbsp;</div> <span><?php echo JText::_('VRLEGFREE'); ?></span></span>
		<?php
		if($showpartlyres) {
		?>
		<span class="vrclegenda"><div class="vrclegwarning">&nbsp;</div> <span><?php echo JText::_('VRLEGWARNING'); ?></span></span>
		<?php
		}
		?>
		<span class="vrclegenda"><div class="vrclegbusy">&nbsp;</div> <span><?php echo JText::_('VRLEGBUSY'); ?></span></span>
...
<h3 class="car-details-header"><?php echo JText::_('VRCSELECTPDDATES'); ?></h3>
...
if (vikrentcar::allowRent()) {
	...
	$coordsplaces = array();
	$selform = "<div class=\"vrcdivsearch vrcdivsearch-comp\"><form action=\"".JRoute::_('index.php?option=com_vikrentcar')."\" method=\"get\" autocomplete=\"off\">\n";
	$selform .= "<div class=\"vrcdivsearch-fieldlist\">";
	...
	if($ptmpl == 'component') {
		$selform .= "<input type=\"hidden\" name=\"tmpl\" value=\"component\" autocomplete=\"off\"/>\n";
	}
	$diffopentime = false;
...
jQuery(function(){
	...
	$selform .= "<div class=\"vrcsfentrycont\"><div class=\"vrcsfentrysubmit\"><input type=\"submit\" name=\"search\" value=\"" . JText::_('VRCBOOKTHISCAR') . "\" class=\"btn vrcdetbooksubmit\"/></div></div>\n";
	$selform .= "</div>";
	$selform .= "\n";
