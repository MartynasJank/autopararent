...
if (vikrentcar::allowRent()) {
	...
	$coordsplaces = array();
	$selform = "<div class=\"vrcdivsearch vrcdivsearch-comp\"><form action=\"".JRoute::_('index.php?option=com_vikrentcar'.(!empty($pitemid) ? : ''))."\" method=\"get\" autocomplete=\"off\">\n";
...
jQuery(function(){
	...
	if (vikrentcar::showCategoriesFront()) {
		...
		if ($dbo->getNumRows() > 0) {
			...
			$selform .= "<div class=\"vrcsfentrycont vrcsfentryselcat\"><label>" . JText :: _('VRCARCAT') . "</label><div class=\"vrcsfentryselect vrcsfentrysel-cat\"><select name=\"categories\">";
	...
	$selform .= "<div class=\"vrcsfentrycont\"><div class=\"vrcsfentrysubmit\"><input type=\"submit\" name=\"search\" value=\"" . vikrentcar :: getSubmitName() . "\"" . (strlen(vikrentcar :: getSubmitClass()) ? " class=\"btn " . vikrentcar :: getSubmitClass() . "\"" : "") . "/></div></div>\n";
	$selform .= "</div>";
	$selform .= "\n";
